...
if (false == $app_basedir)
    die (__FILE__ . ": Error setting 'app_basedir'");
...
$config = array(
    ...
    // The baseurlpath is the url on the webserver where the simplesaml public files are published
    // The public files are the files in the "/vendor/simplesamlphp/simplesamlphp/www" directory
    // For this demo app we omit the "http(s)://domain" part.
    // This demo uses /www as document root, from there is a "simplesaml" symlink to the SimpleSAMLphp
    // public files in vendor directory.
    'baseurlpath' => 'simplesaml/',

    // Directories locations
    'certdir' => $app_basedir . '/config/simplesaml/cert/',
    'loggingdir' => $app_basedir . '/log/',
    'datadir' => $app_basedir . '/data/',
    'metadatadir' => $app_basedir . '/config/simplesaml/metadata/',
     ...
     */
    'tempdir' => $app_basedir . '/tmp/simplesaml',
    ...
    /*
     * This password must be kept secret, and modified from the easily guessed value below.
     ...
     */
    'enable.saml20-idp' => true,    // Required when using SimpleSAMLphp as proxy, set to false otherwise
     ...
     */
    'metadata.sign.privatekey' => 'saml_signing.key',
    'metadata.sign.privatekey_pass' => null,
    'metadata.sign.certificate' => 'saml_signing.crt',
